...
#             method='GetFriendList', 
#             version='1'):
#     	return f'https://api.steampowered.com/IStoreService/GetAppInfo/v{version}/'
...
r = requests.post('https://api.steampowered.com/IStoreService/GetAppInfo/v{version}/', data=dict, headers=dict)
